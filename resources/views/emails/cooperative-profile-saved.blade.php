        ...
        <div class="email-container">
            ...
            <div class="email-header">
                <div class="email-logo-box">
                    @if(file_exists(resource_path('Images/mcdologs.jpg')))
            ...
            <div class="email-body">
                <p class="greeting">
                    Dear {{ $profile->chairperson ? $profile->chairperson : ($profile->name . ' Officers & Representatives') }},
                </p>
                
                <p class="content-text">
                    This is an official confirmation from the Municipal Cooperative Development Office (MCDO). We are pleased to notify you that the profile record for <strong>{{ $profile->name }}</strong> has been successfully 
                    {{ isset($action) && $action === 'updated' ? 'updated in' : 'attached and registered to' }} our municipal database.
                </p>
                ...
                <div class="details-table-wrapper">
                    ...
                    <div class="details-row">
                        ...
                        <span class="details-value">{{ $profile->name }}</span>
                    </div>
                    <div class="details-row">
                        <span class="details-label">CDA Reg. Number:</span>
                        <span class="details-value">{{ $profile->cda_registration_no }}</span>
                    </div>
                    <div class="details-row">
                        <span class="details-label">Cooperative Sector:</span>
                        <span class="details-value">{{ $profile->coop_type }}</span>
                    </div>
                    <div class="details-row">
                        <span class="details-label">Barangay Location:</span>
                        <span class="details-value">{{ $profile->barangay }}</span>
                    </div>
                    @if($profile->chairperson)
                    <div class="details-row">
                        <span class="details-label">Chairperson:</span>
                        <span class="details-value">{{ $profile->chairperson }}</span>
                    </div>
                    @endif
                    <div class="details-row">
                        <span class="details-label">Compliance Status:</span>
                        <span class="details-value">
                            <span class="badge-compliant">{{ $profile->compliance_status ?: 'Compliant' }}</span>
                        </span>
                    </div>
                    <div class="details-row">
            ...
            <div class="email-footer">
                ...
                <p>&copy; {{ date('Y') }} Municipal Cooperative Development Office - Opol. All rights reserved.</p>
            </div>
        </div>
    </div>
</body>

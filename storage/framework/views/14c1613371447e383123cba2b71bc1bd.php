...
<head>
    ...
    <style>
        ...
        .badge-bar {
            background-color: <?php echo e($contactRequest->is_pre_registration_seminar ? '#fee2e2' : '#e0e7ff'); ?>;
            border-bottom: 1px solid <?php echo e($contactRequest->is_pre_registration_seminar ? '#fecaca' : '#c7d2fe'); ?>;
            padding: 10px 24px;
            text-align: center;
        }
        .badge {
            ...
            text-transform: uppercase;
            letter-spacing: 0.5px;
            color: <?php echo e($contactRequest->is_pre_registration_seminar ? '#991b1b' : '#3730a3'); ?>;
        }
        .email-body {
            padding: 30px 24px;
        }
...
<body>
    <div class="email-wrapper">
        <div class="email-container">
            ...
            <div class="badge-bar">
                <span class="badge">
                    <?php if($contactRequest->is_pre_registration_seminar): ?>
                        🏛️ Pre-Registration Seminar Request &bull; Ref #<?php echo e($contactRequest->reference_no); ?>

                    <?php else: ?>
                        📩 Website Inquiry &bull; Ref #<?php echo e($contactRequest->reference_no); ?>
            ...
            <div class="email-body">
                ...
                <div class="meta-card">
                    <div class="meta-row">
                        ...
                        <span class="meta-value"><?php echo e($contactRequest->name); ?></span>
                    </div>
                    <div class="meta-row">
                        <span class="meta-label">Email Address:</span>
                        <span class="meta-value"><a href="mailto:<?php echo e($contactRequest->email); ?>"><?php echo e($contactRequest->email); ?></a></span>
                    </div>
                    <div class="meta-row">
                        <span class="meta-label">Phone Number:</span>
                        <span class="meta-value">
                            <?php if($contactRequest->phone): ?>
                                <a href="tel:<?php echo e($contactRequest->phone); ?>"><?php echo e($contactRequest->phone); ?></a>
                            <?php else: ?>
                    ...
                    <div class="meta-row">
                        ...
                        <span class="meta-value" style="color: #2563eb;"><?php echo e($contactRequest->subject); ?></span>
                    </div>
                    <div class="meta-row">
                        <span class="meta-label">Date Submitted:</span>
                        <span class="meta-value"><?php echo e($contactRequest->created_at ? $contactRequest->created_at->format('M d, Y - h:i A') : now()->format('M d, Y - h:i A')); ?></span>
                    </div>
                </div>
                ...
                <?php if($contactRequest->is_pre_registration_seminar): ?>
                    ...
                    <div class="seminar-box">
                        ...
                        <div class="meta-row">
                            ...
                            <span class="meta-value"><?php echo e($contactRequest->cooperative_name ?: 'Prospective / To be organized'); ?></span>
                        </div>
                        <?php if($contactRequest->attendees_count): ?>
                            <div class="meta-row">
                                <span class="meta-label">Est. Participants:</span>
                                <span class="meta-value"><?php echo e($contactRequest->attendees_count); ?> attendees</span>
                            </div>
                        <?php endif; ?>
                        <?php if($contactRequest->preferred_date): ?>
                            <div class="meta-row">
                                <span class="meta-label">Preferred Date:</span>
                                <span class="meta-value"><?php echo e(\Carbon\Carbon::parse($contactRequest->preferred_date)->format('F d, Y')); ?></span>
                            </div>
                        <?php endif; ?>
                    </div>
                <?php endif; ?>
                ...
                <div class="message-section">
                    ...
                    <div class="message-box"><?php echo e($contactRequest->message); ?></div>
                </div>
                ...
                <div style="text-align: center; margin-top: 28px;">
                    <a href="mailto:<?php echo e($contactRequest->email); ?>?subject=<?php echo e(rawurlencode('RE: ' . $contactRequest->subject . ' [Ref #' . $contactRequest->reference_no . ']')); ?>&body=<?php echo e(rawurlencode($replyBody)); ?>" class="action-button">
            ...
            <div class="email-footer">
                ...
                <p style="margin: 0;">&copy; <?php echo e(date('Y')); ?> Municipal Cooperative Development Office &bull; Opol, Misamis Oriental</p>
            </div>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\Users\User\mcdo\resources\views/emails/contact-inquiry.blade.php ENDPATH**/ ?>